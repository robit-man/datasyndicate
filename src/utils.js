...
const NFT_CONTRACT_ADDRESS = '0x483483D2E48b54719397f270EE20e3aDbeA8F4Ab'
...
export async function mintPepe() {
    ...
    try {
        const resp = await nftContract.mint({ value: ethers.utils.parseEther('1.618033988749894848') });
